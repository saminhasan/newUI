...
static constexpr uint8_t NODE_ID = NODE_ID_MASTER;
static constexpr uint8_t SCOPE_PIN = 32; // Pin for scope triggering
...
typedef union {
    float data[maxArrayLength][NUM_COL];
    uint8_t bytes[maxArrayLength * ROW_SIZE];
} DataBuffer;
#endif // CONSTANTS_H
